/*! Select2 4.0.6-rc.1 | https://github.com/select2/select2/blob/master/LICENSE.md */ !(function (a) {
    ...
    $('.select2-search__field').on('keyup', function(){
        $('.select2-dropdown').addClass('tw-bg-transparent');
        $('.select2-dropdown').addClass('tw-shadow-none');
        $('.select2-results__option').addClass('tw-text-2xl');
        $('.select2-results__option').addClass('tw-bg-transparent');
        $('.select2-results__option').addClass('hover:tw-text-gray-700');
        $('.select2-results__option').addClass('hover:tw-font-bold');
        $('.select2-dropdown').addClass('tw--mt-10');
