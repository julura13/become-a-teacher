<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
            <div class="">
               <img src="{{ asset('images/logo-white.png')}}" class="header-brand-img tw-h-12" title="JGF"> 
            </div>
        </a>
    ...
    <div class="sidebar-content pt-10">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ ($segment1 == 'candidates') ? 'active' : '' }}">
                    <a href="/candidates"><i class="ik ik-users"></i><span>{{ __('Candidates')}}</span></a>
                </div>

                <div class="nav-item {{ ($segment1 == 'users' || $segment1 == 'roles'||$segment1 == 'permission' ||$segment1 == 'user') ? 'active open' : '' }} has-sub">
                    <a href="#"><i class="ik ik-file"></i><span>{{ __('Pathways (Methodologies)')}}</span></a>
                    <div class="submenu-content">
                        <!-- only those have manage_user permission will get access -->
                     
                        <a href="{{url('pathways')}}" class="menu-item {{ ($segment1 == 'pathways') ? 'active' : '' }}">{{ __('Pathways')}}</a>
                        <a href="{{url('create/pathway')}}" class="menu-item {{ ($segment1 == 'pathway' && $segment2 == 'create') ? 'active' : '' }}">{{ __('Add pathway')}}</a>
                      
                    </div>
                </div>
                
                <div class="nav-item {{ ($segment1 == 'users' || $segment1 == 'roles'||$segment1 == 'permission' ||$segment1 == 'user') ? 'active open' : '' }} has-sub">
                    <a href="#"><i class="ik ik-copy"></i><span>{{ __('Courses (Requirements)')}}</span></a>
                    <div class="submenu-content">
                       
                        <a href="{{url('courses')}}" class="menu-item {{ ($segment1 == 'courses') ? 'active' : '' }}">{{ __('Courses')}}</a>
                        <a href="{{url('create/course')}}" class="menu-item {{ ($segment1 == 'course' && $segment2 == 'create') ? 'active' : '' }}">{{ __('Add Course')}}</a>
                        <a href="{{url('categories')}}" class="menu-item {{ ($segment1 == 'categories') ? 'active' : '' }}">{{ __('Categories')}}</a>
                        <a href="{{url('create/category')}}" class="menu-item {{ ($segment1 == 'category' && $segment2 == 'create') ? 'active' : '' }}">{{ __('Add Category')}}</a>
