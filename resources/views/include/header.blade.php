    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            ...
            <div class="top-menu d-flex align-items-center">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle tw-align-middle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="tw-inline tw--pt-10">
                            <span class="tw-text-base">{{ \Auth::user()->name }}</span>

                        </div>
                        <img class="avatar" src="{{ asset('img/blank-avatar.png')}}" alt="">
                    </a>
