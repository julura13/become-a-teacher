...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Login | Jakes Gerwel Fellowship - How to become a teacher</title>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                        <div class="authentication-form mx-auto">
                            <div class="logo-centered">
                                <a href="{{ url('/')}}"><img height="" src="{{ asset('images/logo.png') }}" alt="RADMIN" ></a>
                            </div>
                            <div class="text-center mb-4">
                                <h4 class="text-center">How to qualify as a teacher in South Africa</h4>
                            </div>
{{--                            <p>Welcome!</p>--}}
